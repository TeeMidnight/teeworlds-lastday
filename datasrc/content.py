...
container.sounds.Add(SoundSet("gun_fire", FileList("audio/wp_gun_fire-%02d.opus", 3)))
container.sounds.Add(SoundSet("shotgun_fire", FileList("audio/wp_shotty_fire-%02d.opus", 3)))

container.sounds.Add(SoundSet("grenade_fire", FileList("audio/wp_flump_launch-%02d.opus", 3)))
container.sounds.Add(SoundSet("hammer_fire", FileList("audio/wp_hammer_swing-%02d.opus", 3)))
container.sounds.Add(SoundSet("hammer_hit", FileList("audio/wp_hammer_hit-%02d.opus", 3)))
container.sounds.Add(SoundSet("ninja_fire", FileList("audio/wp_ninja_attack-%02d.opus", 3)))
container.sounds.Add(SoundSet("grenade_explode", FileList("audio/wp_flump_explo-%02d.opus", 3)))
container.sounds.Add(SoundSet("ninja_hit", FileList("audio/wp_ninja_hit-%02d.opus", 3)))
container.sounds.Add(SoundSet("laser_fire", FileList("audio/wp_laser_fire-%02d.opus", 3)))
container.sounds.Add(SoundSet("laser_bounce", FileList("audio/wp_laser_bnce-%02d.opus", 3)))
container.sounds.Add(SoundSet("weapon_switch", FileList("audio/wp_switch-%02d.opus", 3)))

container.sounds.Add(SoundSet("player_pain_short", FileList("audio/vo_teefault_pain_short-%02d.opus", 12)))
container.sounds.Add(SoundSet("player_pain_long", FileList("audio/vo_teefault_pain_long-%02d.opus", 2)))

container.sounds.Add(SoundSet("body_land", FileList("audio/foley_land-%02d.opus", 4)))
container.sounds.Add(SoundSet("player_airjump", FileList("audio/foley_dbljump-%02d.opus", 3)))
container.sounds.Add(SoundSet("player_jump", FileList("audio/foley_foot_left-%02d.opus", 4) + FileList("audio/foley_foot_right-%02d.opus", 4)))
container.sounds.Add(SoundSet("player_die", FileList("audio/foley_body_splat-%02d.opus", 3)))
container.sounds.Add(SoundSet("player_spawn", FileList("audio/vo_teefault_spawn-%02d.opus", 7)))
container.sounds.Add(SoundSet("player_skid", FileList("audio/sfx_skid-%02d.opus", 4)))
container.sounds.Add(SoundSet("tee_cry", FileList("audio/vo_teefault_cry-%02d.opus", 2)))

container.sounds.Add(SoundSet("hook_loop", FileList("audio/hook_loop-%02d.opus", 2)))

container.sounds.Add(SoundSet("hook_attach_ground", FileList("audio/hook_attach-%02d.opus", 3)))
container.sounds.Add(SoundSet("hook_attach_player", FileList("audio/foley_body_impact-%02d.opus", 3)))
container.sounds.Add(SoundSet("hook_noattach", FileList("audio/hook_noattach-%02d.opus", 2)))
container.sounds.Add(SoundSet("pickup_health", FileList("audio/sfx_pickup_hrt-%02d.opus", 2)))
container.sounds.Add(SoundSet("pickup_armor", FileList("audio/sfx_pickup_arm-%02d.opus", 4)))

container.sounds.Add(SoundSet("pickup_grenade", ["audio/sfx_pickup_launcher.opus"]))
container.sounds.Add(SoundSet("pickup_shotgun", ["audio/sfx_pickup_sg.opus"]))
container.sounds.Add(SoundSet("pickup_ninja", ["audio/sfx_pickup_ninja.opus"]))
container.sounds.Add(SoundSet("weapon_spawn", FileList("audio/sfx_spawn_wpn-%02d.opus", 3)))
container.sounds.Add(SoundSet("weapon_noammo", FileList("audio/wp_noammo-%02d.opus", 5)))

container.sounds.Add(SoundSet("hit", FileList("audio/sfx_hit_weak-%02d.opus", 2)))

container.sounds.Add(SoundSet("chat_server", ["audio/sfx_msg-server.opus"]))
container.sounds.Add(SoundSet("chat_client", ["audio/sfx_msg-client.opus"]))
container.sounds.Add(SoundSet("chat_highlight", ["audio/sfx_msg-highlight.opus"]))
container.sounds.Add(SoundSet("ctf_drop", ["audio/sfx_ctf_drop.opus"]))
container.sounds.Add(SoundSet("ctf_return", ["audio/sfx_ctf_rtn.opus"]))
container.sounds.Add(SoundSet("ctf_grab_pl", ["audio/sfx_ctf_grab_pl.opus"]))
container.sounds.Add(SoundSet("ctf_grab_en", ["audio/sfx_ctf_grab_en.opus"]))
container.sounds.Add(SoundSet("ctf_capture", ["audio/sfx_ctf_cap_pl.opus"]))

container.sounds.Add(SoundSet("menu", ["audio/music_menu.opus"]))
