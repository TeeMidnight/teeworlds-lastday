...
MACRO_CONFIG_INT(SvMapDownloadSpeed, sv_map_download_speed, 12, 1, 16, CFGFLAG_SAVE | CFGFLAG_SERVER, "Number of map data packages a client gets on each request")
